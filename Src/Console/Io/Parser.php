...
/**
 * 格式化命令
 * @author Swoft\Console\Helper
 * @date 18-7-19 上午11:24
 */
...
class Parser
{
     ...
     * @return array
     */
    public function parse(array $params, array $config = []): array
    {
        $config = array_merge([
     ...
     * @return boolean
     */
    private function supportColor(): bool
    {
     ...
     * @return bool
     */
    private function isSupport256Color(): bool
    {
